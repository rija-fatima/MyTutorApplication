# Generated by Django 2.1.5 on 2020-03-21 17:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teachers', models.ManyToManyField(related_name='teachers', to='mytutor.User')),
            ],
        ),
        migrations.CreateModel(
            name='Subject',
            fields=[
                ...
                ('tutor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mytutor.User')),
            ],
        ),
    ]
